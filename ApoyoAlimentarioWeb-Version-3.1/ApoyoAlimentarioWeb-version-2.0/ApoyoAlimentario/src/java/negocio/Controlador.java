...
public class Controlador {
    ...
    public String crearSocilicitud(String usuario,String contrasenia, Solicitud s, ArrayList<Integer> llaves,ArrayList<LinkId> links){
        logearse(usuario, contrasenia);//loggearse como estudiante    
        SolicitudDAO solicitudDAO = new SolicitudDAO(); 
        return solicitudDAO.incluirSolicitud(s, llaves,links);//realiza el proceso de incluir solicitud y devuelve el mensaje
    }
    ...
    public String actualizarConvocatoria(String usuario, String contrasenia, Convocatoria convocatoria ){
        logearse(usuario, contrasenia);
        ConvocatoriaDAO convocatoriaDAO = new ConvocatoriaDAO();
        convocatoriaDAO.modificarAnioConvocatoria(convocatoria.getCodigo(), convocatoria.getAnio());
        convocatoriaDAO.modificarSemestreConvocatoria(convocatoria.getCodigo(), convocatoria.getSemestre());
        return convocatoriaDAO.modificarFechasConvocatoria(convocatoria.getCodigo(), convocatoria.getFechaInicio(), convocatoria.getFechaFin(), convocatoria.getTipoProceso());
    }
