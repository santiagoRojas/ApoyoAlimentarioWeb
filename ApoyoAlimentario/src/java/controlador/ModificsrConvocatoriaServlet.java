...
public class ModificsrConvocatoriaServlet extends HttpServlet {
	...
	String pass = request.getParameter("contraseña");
        ...
        String error = control.actualizarConvocatoria(user, pass,convocatoria.getCodigo(),convocatoria.getFechaInicio(),convocatoria.getFechaFin() );//cuando tenga listo el modificar en dao se cambia el nombre del metodo
        if(error == null){
            error= "se ha modificado la convocatoria con exito";
