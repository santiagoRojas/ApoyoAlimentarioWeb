...
%>
    ...
    <body id="page-top">
        ...
        <div class="portfolio-modal modal fade" id="portfolioModal3" tabindex="-1" role="dialog" aria-hidden="true">
           ...
           <!-- Convocatoria-->
        <section class="page-section bg-light" id="convocatoria">
                <div class="text-center">
                    <h2 class="section-heading text-uppercase">Convocatoria</h2>
                    <h3 class="section-subheading text-muted">En los siguientes enlaces encontrara información acerca  de las convocatorias</h3>   
                </div>
                <div id="mconvocatoria">
                    <form method="POST" action="MostrarConvocatorias">
                      <input type="hidden" value="<%=usuario%>" name="usuario">
                      <input type="hidden" value="<%=contra%>" name="contraseña">
                    <button class="btn btn-primary btn-xl text-uppercase js-scroll-trigger" type="submit" id="verC">Ver Convocatorias</button>
                    </form>
                    <a class="btn btn-primary btn-xl text-uppercase js-scroll-trigger" href="CrearConvocatoria.jsp" id="crearC">Crear Convocatorias</a>
                </div>
        </section>
        <!-- Team-->
