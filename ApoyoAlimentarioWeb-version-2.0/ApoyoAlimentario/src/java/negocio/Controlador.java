...
public class Controlador {
    ...
    public String crearSocilicitud(String usuario,String contrasenia, Solicitud s, ArrayList<Integer> llaves){
        logearse(usuario, contrasenia);//loggearse como estudiante    
        SolicitudDAO solicitudDAO = new SolicitudDAO(); 
        return solicitudDAO.incluirSolicitud(s, llaves);//realiza el proceso de incluir solicitud y devuelve el mensaje
    }
